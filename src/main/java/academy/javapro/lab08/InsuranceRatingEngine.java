...
public class InsuranceRatingEngine {
    ...
    private String determineVehicleCategory(DriverProfile profile) {
        ...
        make.equals("lexus") || make.equals("audi")) {
            return "luxury";
        } else if(make.equals("ferrari") || make.equals("porsche") ||
         model.equals("mustang") || model.equals("corvette")) {
            return "sports";
        } else if(model.equals("suv") || model.equals("explorer") || 
        make.equals("tahoe") || make.equals("highlander")) {
            return "suv";
        } else {
            return "sedan";
        }
